...
### Known Issues
* Data model was updated in 3.1.6, devtool.typings needs to be reworked to support new classes
* Developer documentation needs some rework / updates
