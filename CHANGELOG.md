...
## [3.0.0] - 2022-11-22
### Added
- Modular architecture with a major rewrite of all components.
- Administrator App for managing and deploying IDEA clusters.
- New Module: Cluster
- New Module: Metrics & Monitoring
- New Module: Analytics
- New Module: Directory Service
- New Module: Identity Provider
- New Module: Shared Storage
- New Module: eVDI
- New Module: Scale-Out Computing
