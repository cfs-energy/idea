...
class SocaDevelopmentProps:
    ...
    def idea_release_version(self) -> str:
        with open(os.path.join(self.project_root_dir, 'IDEA_VERSION.txt')) as f:
            return f.read().strip()
    ...
    def virtual_desktop_tests_src(self) -> str:
        return os.path.join(self.virtual_desktop_project_dir, 'tests')
    ...
    def cluster_manager_tests_src(self) -> str:
        return os.path.join(self.cluster_manager_project_dir, 'tests')
    ...
    def sdk_tests_src(self) -> str:
        return os.path.join(self.sdk_project_dir, 'tests')
