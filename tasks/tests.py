...
@task(iterable=['params'])
def scheduler(c, keywords=None, params=None, capture_output=False, cov_report=None):
    # type: (Context, str, List[str], bool, str) -> None
    """
    ...
    exit_code = _run_unit_tests(
        ...
        component_src=idea.props.scheduler_src,
        component_tests_src=idea.props.scheduler_tests_src,
        package_name='ideascheduler',
        params=params,
        capture_output=capture_output,
        keywords=keywords,
        cov_report=cov_report
