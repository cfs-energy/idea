...
JobProvisioningQueueType = TypeVar(
    'JobProvisioningQueueType', bound=JobProvisioningQueueProtocol
)
...
class HpcQueueProfilesServiceProtocol(SocaServiceProtocol):
    ...
    def create_queue_profile(
        self, queue_profile: HpcQueueProfile
    ) -> HpcQueueProfile: ...
    ...
    ) -> Optional[JobProvisioningQueueProtocol]: ...
