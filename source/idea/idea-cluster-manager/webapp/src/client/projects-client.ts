...
class ProjectsClient extends IdeaBaseClient<ProjectsClientProps> {
    ...
    createProject(req: CreateProjectRequest): Promise<CreateProjectResult> {
        return this.apiInvoker.invoke_alt<CreateProjectRequest, CreateProjectResult>(
    ...
    getProject(req: GetProjectRequest): Promise<GetProjectResult> {
        return this.apiInvoker.invoke_alt<GetProjectRequest, GetProjectResult>(
            'Projects.GetProject',
            req
        )
    }
    ...
    deleteProject(req: DeleteProjectRequest): Promise<DeleteProjectResult> {
        return this.apiInvoker.invoke_alt<DeleteProjectRequest, DeleteProjectResult>(
    ...
    updateProject(req: UpdateProjectRequest): Promise<UpdateProjectResult> {
        return this.apiInvoker.invoke_alt<UpdateProjectRequest, UpdateProjectResult>(
    ...
    getUserProjects(req: GetUserProjectsRequest): Promise<GetUserProjectsResult> {
        return this.apiInvoker.invoke_alt<GetUserProjectsRequest, GetUserProjectsResult>(
    ...
    enableProject(req: EnableProjectRequest): Promise<EnableProjectResult> {
        return this.apiInvoker.invoke_alt<EnableProjectRequest, EnableProjectResult>(
    ...
    disableProject(req: DisableProjectRequest): Promise<DisableProjectResult> {
        return this.apiInvoker.invoke_alt<DisableProjectRequest, DisableProjectResult>(
