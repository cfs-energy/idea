...
import {
    DescribeServersRequest, DescribeServersResponse,
    DescribeSessionsRequest, DescribeSessionsResponse
...
class VirtualDesktopDCVClient extends IdeaBaseClient<VirtualDesktopDCVClientProps> {
    ...
    describeSessions(req: DescribeSessionsRequest): Promise<DescribeSessionsResponse> {
        return this.apiInvoker.invoke_alt<DescribeSessionsRequest, DescribeSessionsResponse>(
    ...
    describeServers(req: DescribeServersRequest): Promise<DescribeServersResponse> {
        return this.apiInvoker.invoke_alt<DescribeServersRequest, DescribeServersResponse>(
