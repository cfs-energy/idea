...
vi.mock('../pages/cluster-admin/portal-settings', () => ({default: (props: any) => <IdeaAppLayout {...props} content={<p>Settings content</p>}/>, SettingsServiceDetails: (props: any) => <IdeaAppLayout {...props} content={<p>Service content</p>}/>}));
...
it.each([
    ...
    ['/cluster/users?view=reconciliation', 'People and access'],
    ...
    if (path !== '/dashboard') expect(screen.getByTestId('url').textContent).toBe(path);
});
