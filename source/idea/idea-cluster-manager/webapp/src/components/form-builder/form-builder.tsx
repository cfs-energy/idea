            ...
            <Grid gridDefinition={[{colspan: 1}, {colspan: 9}, {colspan: 2}]}>
                ...
                {this.state.edit &&
                    <div>
                        ...
                        <Container variant="default">
                            ...
                            {this.state.param.param_type === 'select' && <div>
                                <Box
                                    margin={{bottom: "xxxs", top: 'l'}}
                                    color="text-label">
                                    Choices
                                </Box>
                                <AttributeEditor
                                    ...
                                    definition={[
                                        {
                                            ...
                                            control: (item: SocaUserInputChoice) => (
                                                <Input value={Utils.asString(item.title)} onChange={(event) => {
                                                    const choices = this.state.choices
                                        ...
                                        },
                                        {
                                            label: 'Value',
                                            control: (item: SocaUserInputChoice) => (
                                                <Input value={Utils.asString(item.value)} onChange={(event) => {
                                                    const choices = this.state.choices
                                                    choices.forEach((choice) => {
                            ...
                            <SpaceBetween direction="vertical" size="m">
                                <div>
                                    <h4>Preview</h4>
                                    <div style={{backgroundColor: '#f1f1f1', boxSizing: 'border-box', padding: '20px'}}>
                                        {this.state.showPreview && <IdeaFormField
                                            ref={this.preview}
                                ...
                                <Box float="right">
                                    <SpaceBetween size={"xs"} direction="horizontal">
                                        <Button onClick={this.onEdit} variant="primary"><FontAwesomeIcon icon={editIcon()}/> Save</Button>
                                    </SpaceBetween>
                                </Box>
                            </SpaceBetween>
                        </Container>
                    ...
                    <div>
                        ...
                        <Container variant="default">
                            <IdeaFormField
                                module={this.props.id}
                                param={this.build()}
                                value={this.state.param.default}
                            />
                        </Container>
                    </div>
                }
                <SpaceBetween size="xs" direction="vertical">
                    <SpaceBetween size="xxxs" direction="horizontal">
                        {!this.state.edit && <Button onClick={this.onEdit} variant="normal"><FontAwesomeIcon icon={editIcon()}/></Button>}
                        {this.state.edit &&
                            <Button onClick={this.onClose} variant="normal"><FontAwesomeIcon icon={faWindowClose}/></Button>}
                    </SpaceBetween>
                    <Button onClick={this.onCopy} variant="normal"><FontAwesomeIcon icon={faCopy}/></Button>
                    <Button onClick={this.onDelete} variant="normal"><FontAwesomeIcon icon={faTrash}/></Button>
                </SpaceBetween>
            </Grid>
        )
    }
...
class SocaFormBuilder extends Component<IdeaFormBuilderProps, IdeaFormBuilderState> {
    ...
    setFields(params: SocaUserInputParamMetadata[]) {
        ...
        params.forEach(param => metadata.push({
            id: Utils.getUUID(),
            param: param
        }))
        this.setState({
    ...
    buildInfoSection() {
        if (this.props.infoSection) {
            ...
            return <div>
                <p>Design your form using <strong>Form Builder</strong>. You can preview the generated form using
                    the <strong>Preview Form</strong> tab. </p>
            </div>
        }
    }
            ...
            <div className={"idea-form-builder"}>
                <ColumnLayout columns={2}>
                    ...
                    <div>
                        <Box float="right">
                            <SpaceBetween size="xs" direction="horizontal">
                                <Button variant="normal" onClick={() => this.setFields([])}>Reset Form</Button>
                                <Button variant="primary" onClick={() => this.addField()}>Add Form Field</Button>
                            </SpaceBetween>
                        </Box>
                    </div>
                </ColumnLayout>
                    ...
                    tabs={[
                        {
                            ...
                            content: (
                                <ColumnLayout columns={2}>
                                    ...
                                    <Container variant="default">
                                        <p>Click <strong>Check Form Parameters</strong> to verify the generated values below:</p>
