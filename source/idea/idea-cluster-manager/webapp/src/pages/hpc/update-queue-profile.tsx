...
class HpcUpdateQueueProfile extends Component<HpcUpdateQueueProfileProps, HpcUpdateQueueProfileState> {
    ...
    componentDidMount() {
        if (this.isUpdate()) {
            ...
            this.schedulerAdmin().getQueueProfile({
                    ...
                    <IdeaWizard
                                            ...
                                            params: [
                                                {
                                                    ...
                                                    help_text: 'Name must be all lowercase, and should not contain spaces or special characters except (-). Name cannot be edited after creation.',
                                                    param_type: 'text',
                                                    data_type: 'str',
                                                    validate: {
                                                        required: true,
                                            ...
                                            params: [
                                                {
                                                    ...
                                                    description: 'Enter scheduler queue names. The queues will be automatically created' +
                                                        ' if they do not already exist. When multiple queues are provided, jobs in the first queue will have a higher priority for provisioning than the last queue.',
                                                    param_type: 'text',
                                                    data_type: 'str',
                                                    multiple: true,
                                                    validate: {
                                                ...
                                                },
                                                {
                                                    ...
                                                    choices: [
                                                        ...
                                                        {
                                                            title: 'Batch',
                                                            description: 'Jobs submitted in close succession will be provisioned in batches. New jobs will reuse existing capacity if available. ' +
                                                                'Provisioned capacity will be dynamically adjusted based on new batches submitted.',
                                                            value: 'batch'
                                                        }
                                                    ],
                                                    validate: {
                                    ...
                                    groups: [
                                        {
                                            ...
                                            params: [
                                                ...
                                                },
                                                {
                                                    ...
                                                    description: 'Enter default instance types for the Job. When multiple instance types are provided, instances will be provisioned using weighted capacities. ' +
                        ...
                        onSubmit={() => {
                            ...
                            if (utils.isScratchStorageEnabled()) {
                                ...
                                dot.del('default_job_params.scratch_storage_iops', queueProfile)
                                dot.del('default_job_params.fsx_lustre', queueProfile)
                                dot.str('default_job_params.fsx_lustre', {
                                    enabled: false
                                }, queueProfile)
                            }
