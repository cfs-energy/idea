    ...
    save() {
        if (this.state.session) {
            ...
            this.setState({
                ...
                this.props.onScheduleChange(this.state.session!)
                    .then(status => {
                        if (status) {
                            this.cancel()
                        } else {
                    ...
                    <Form errorText={this.state.errorMessage}>
                        <ColumnLayout columns={1}>
                            <VirtualDesktopDayOfWeekSchedule
                                ...
                                dayOfWeek="Monday"
                                schedule={this.state.session?.schedule?.monday}
                            ...
                            <VirtualDesktopDayOfWeekSchedule
                                ...
                                dayOfWeek="Tuesday"
                                schedule={this.state.session?.schedule?.tuesday}
                                working_hours_start={this.state.working_hours_start}
                                working_hours_end={this.state.working_hours_end}
                            />
                            <VirtualDesktopDayOfWeekSchedule
                                ...
                                dayOfWeek="Wednesday"
                                schedule={this.state.session?.schedule?.wednesday}
                                working_hours_start={this.state.working_hours_start}
                                working_hours_end={this.state.working_hours_end}
                            />
                            <VirtualDesktopDayOfWeekSchedule
                                ...
                                dayOfWeek="Thursday"
                                schedule={this.state.session?.schedule?.thursday}
                                working_hours_start={this.state.working_hours_start}
                                working_hours_end={this.state.working_hours_end}
                            />
                            <VirtualDesktopDayOfWeekSchedule
                                ...
                                dayOfWeek="Friday"
                                schedule={this.state.session?.schedule?.friday}
                                working_hours_start={this.state.working_hours_start}
                                working_hours_end={this.state.working_hours_end}
                            />
                            <VirtualDesktopDayOfWeekSchedule
                                ...
                                dayOfWeek="Saturday"
                                schedule={this.state.session?.schedule?.saturday}
                                working_hours_start={this.state.working_hours_start}
                                working_hours_end={this.state.working_hours_end}
                            />
                            <VirtualDesktopDayOfWeekSchedule
                                ...
                                dayOfWeek="Sunday"
                                schedule={this.state.session?.schedule?.sunday}
                                working_hours_start={this.state.working_hours_start}
                                working_hours_end={this.state.working_hours_end}
                            />
                        </ColumnLayout>
