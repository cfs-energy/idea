...
class AuthAPI(BaseAPI):
    ...
    def add_user_to_group(self, context: ApiInvocationContext):
        ...
        self.context.accounts.add_users_to_group(request.usernames, group_name)
    ...
    def remove_user_from_group(self, context: ApiInvocationContext):
        ...
        self.context.accounts.remove_users_from_group(request.usernames, group_name)
    ...
    def invoke(self, context: ApiInvocationContext):
        ...
        elif namespace == 'Auth.AddUserToGroup':
            self.add_user_to_group(context)
        elif namespace == 'Auth.RemoveUserFromGroup':
            self.remove_user_from_group(context)
