...
class CliContext(object):
    ...
    def as_dict(self):
        return {'verbosity': self.verbosity, 'debug': self.debug, 'format': self.format}
...
def common_options(include: list = None, exclude: list = None):
    def add_common_options(func):
        mandatory = {'format': format_option}

        optional = {'debug': debug_option, 'verbosity': verbosity_option}
