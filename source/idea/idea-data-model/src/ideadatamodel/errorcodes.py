...
# the project's bedrock access is not usable yet and is expected to become usable
BEDROCK_ACCESS_NOT_READY = 'BEDROCK_ACCESS_NOT_READY'
# the project's bedrock access cannot be granted to this job without a config change
BEDROCK_ACCESS_NOT_AUTHORIZED = 'BEDROCK_ACCESS_NOT_AUTHORIZED'
...
SCHEDULER_INVALID_LICENSE_RESOURCE_CONFIGURATION = (
    'INVALID_LICENSE_RESOURCE_CONFIGURATION'
)
...
JOB_PROVISIONING_RETRIES_EXHAUSTED = 'JOB_PROVISIONING_RETRIES_EXHAUSTED'
...
JOB_SUBMISSION_IN_PROGRESS = 'JOB_SUBMISSION_IN_PROGRESS'
...
CREATED_SOFTWARE_STACK_FROM_SESSION_FAILED = (
    'CREATED_SOFTWARE_STACK_FROM_SESSION_FAILED'
)
...
AD_AUTOMATION_DELETE_COMPUTER_FAILED = 'AD_AUTOMATION_DELETE_COMPUTER_FAILED'
