...
IDEA_TAG_CLUSTER_NAME = IDEA_TAG_PREFIX + 'ClusterName'
...
JOB_PARAM_ENABLE_SYSTEM_METRICS = 'enable_system_metrics'
...
# SQS settings
#
SQS_MAX_RECEIVE_COUNT_DEFAULT = 16
SQS_MAX_RECEIVE_COUNT_AD_AUTOMATION = SQS_MAX_RECEIVE_COUNT_DEFAULT
SQS_MAX_RECEIVE_COUNT_CLUSTER_TASKS = SQS_MAX_RECEIVE_COUNT_DEFAULT
SQS_MAX_RECEIVE_COUNT_VDC_CONTROLLER = SQS_MAX_RECEIVE_COUNT_DEFAULT
SQS_MAX_RECEIVE_COUNT_VDC_EVENTS = SQS_MAX_RECEIVE_COUNT_DEFAULT
SQS_MAX_RECEIVE_COUNT_NOTIFICATIONS = 3
SQS_MAX_RECEIVE_COUNT_SCHEDULER_JOB_STATUS = 10

#
# SQS visibility timeout defaults
#
SQS_VISIBILITY_TIMEOUT_DEFAULT = 30
SQS_VISIBILITY_TIMEOUT_AD_AUTOMATION = SQS_VISIBILITY_TIMEOUT_DEFAULT
SQS_VISIBILITY_TASKS = SQS_VISIBILITY_TIMEOUT_DEFAULT
SQS_VISIBILITY_NOTIFICATIONS = SQS_VISIBILITY_TIMEOUT_DEFAULT
SQS_VISIBILITY_VDC_CONTROLLER = SQS_VISIBILITY_TIMEOUT_DEFAULT
SQS_VISIBILITY_VDC_EVENTS = SQS_VISIBILITY_TIMEOUT_DEFAULT
SQS_VISIBILITY_SCHEDULER_JOB_STATUS = SQS_VISIBILITY_TIMEOUT_DEFAULT
#
# Caveat definitions
#
CAVEATS = dict()
