...
USER_SESSION_DB_STOPPED_ON_KEY = 'stopped_on'
...
USER_SESSION_DB_CLEANUP_EXEMPT_KEY = 'cleanup_exempt'
USER_SESSION_DB_CLEANUP_EXEMPT_REASON_KEY = 'cleanup_exempt_reason'
USER_SESSION_DB_CLEANUP_WARNING_SENT_ON_KEY = 'cleanup_warning_sent_on'
USER_SESSION_DB_CLEANUP_WARNING_STOP_TIME_KEY = 'cleanup_warning_stop_time'
