...
SOFTWARE_STACK_DB_BASE_AMI_ID_KEY = 'base_ami_id'
...
# Warming pool
SOFTWARE_STACK_DB_POOL_ENABLED_KEY = 'pool_enabled'
SOFTWARE_STACK_DB_POOL_ASG_KEY = 'pool_asg_name'

# Launch Tenancy
SOFTWARE_STACK_DB_LAUNCH_TENANCY_KEY = 'launch_tenancy'
