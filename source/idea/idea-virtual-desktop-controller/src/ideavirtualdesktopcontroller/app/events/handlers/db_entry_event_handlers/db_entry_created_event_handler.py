...
class DbEntryCreatedEventHandler(BaseDBEventHandler):
    def __init__(self, context: ideavirtualdesktopcontroller.AppContext):
        ...
        self.DETAIL_TYPE_TYPE_DB_ENTRY_CREATED_HANDLER: Dict[
            str, Callable[[str, str, dict, str], None]
        ] = {
    ...
    def _handle_software_stack_created(
        self, _: str, __: str, new_value: dict, ___: str
    ):
        software_stack = (
    ...
    def _handle_permission_profile_created(
        self, _: str, __: str, ___: dict, table_name: str
    ):
        self._logger.debug(
            f'created entry for {table_name} not handled. No=OP. Returning'
        )
    ...
    def _handle_session_permission_created(
        self, _: str, __: str, new_value: dict, ___: str
    ):
        session_permission = (
        ...
        self.session_permission_utils.index_session_permission_to_opensearch(
        ...
        self.context.notification_async_client.send_notification(
            Notification(
                ...
                params={
                    ...
                    'formatted_expiry_date': session_permission.expiry_date.strftime(
                        '%B %d, %Y at %I:%M %p'
                    ),
                },
            )
    ...
    def handle_event(self, message_id: str, sender_id: str, event: VirtualDesktopEvent):
        ...
        self.DETAIL_TYPE_TYPE_DB_ENTRY_CREATED_HANDLER[table_name](
            hash_key, range_key, new_value, table_name
        )
