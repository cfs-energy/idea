...
class DCVBrokerClientUtils:
    ...
    def get_storage_root_for_base_os(base_os: VirtualDesktopBaseOS, owner) -> str:
        if base_os in (VirtualDesktopBaseOS.AMAZON_LINUX2, VirtualDesktopBaseOS.AMAZON_LINUX2023, VirtualDesktopBaseOS.CENTOS7, VirtualDesktopBaseOS.RHEL7, VirtualDesktopBaseOS.RHEL8, VirtualDesktopBaseOS.RHEL9, VirtualDesktopBaseOS.ROCKY8, VirtualDesktopBaseOS.ROCKY9):
