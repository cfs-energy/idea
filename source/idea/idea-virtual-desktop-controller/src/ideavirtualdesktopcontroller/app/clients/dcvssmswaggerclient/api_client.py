...
import six
import ideavirtualdesktopcontroller.app.clients.dcvssmswaggerclient.models
from six.moves.urllib.parse import quote  # type: ignore
from ideavirtualdesktopcontroller.app.clients.dcvssmswaggerclient import rest
...
class ApiClient(object):
    ...
    NATIVE_TYPES_MAPPING = {
        'int': int,
        'long': int,  # In Python 3, long is unified with int
        'float': float,
        'str': str,
        'bool': bool,
        'date': datetime.date,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(
                    ideavirtualdesktopcontroller.app.clients.dcvssmswaggerclient.models,
                    klass,
                )
