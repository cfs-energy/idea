...
class Server(object):
    ...
    def __init__(
        ...
        ip=None,
        hostname=None,
        default_dns_name=None,
        port=None,
        endpoints=None,
        web_url_path=None,
        version=None,
        session_manager_agent_version=None,
        availability=None,
        unavailability_reason=None,
        console_session_count=None,
        virtual_session_count=None,
        host=None,
        tags=None,
    ):  # noqa: E501
    ...
    def availability(self, availability):
        ...
        if availability not in allowed_values:
            raise ValueError(
                'Invalid value for `availability` ({0}), must be one of {1}'.format(  # noqa: E501
                    availability, allowed_values
                )
            )
    ...
    def unavailability_reason(self, unavailability_reason):
        ...
        if unavailability_reason not in allowed_values:
            raise ValueError(
                'Invalid value for `unavailability_reason` ({0}), must be one of {1}'.format(  # noqa: E501
                    unavailability_reason, allowed_values
                )
            )
