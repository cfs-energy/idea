...
class CdkInvoker:
    ...
    For IDEA, CDK stacks and constructs in Python, which are synthesized to a cloud formation template that are processed by CDK nodejs binary.
    ...
    1. as an installed app (currently used primarily in Docker Container flows)
        ...
        - this makes invocation of cdk easier, where the --app in cdk becomes::
            ...
            cdk --app 'idea-admin cdk cdk-app --cluster-name idea-dev2 --aws-region us-east-1 --module-id bootstrap --module-name bootstrap --deployment-id 700f4b2c-110b-4395-a208-b13874d20ec5 --termination-protection true'

        - `idea-admin cdk cdk-app .. ..` synthesizes the cloudformation template and cdk uses the template to deploy the stack
    ...
    2. from sources during development (Dev Mode)
        ...
        - the command to invoke cdk becomes::
            ...
            cdk --app 'invoke cli.admin --args base64("cdk cdk-app --cluster-name idea-dev2 --aws-region us-east-1 --module-id bootstrap --module-name bootstrap --deployment-id 700f4b2c-110b-4395-a208-b13874d20ec5 --termination-protection true")
    ...
    def get_cdk_app_cmd(self) -> str:
        ...
        if ideaadministrator.props.is_dev_mode():
            ...
            cdk_app_cmd = f'idea-admin cdk cdk-app {cdk_app_args_s}'
