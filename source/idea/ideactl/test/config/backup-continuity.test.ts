...
const configTemplates = join(packageRoot, "resources", "config", "templates");
const clusterSettingsTemplate = join(configTemplates, "cluster", "settings.yml");
const vdcSettingsTemplate = join(configTemplates, "virtual-desktop-controller", "settings.yml");
