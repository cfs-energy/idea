...
export function fullContext(): Record<string, unknown> {
  ...
  return {
    ...
    vars: {
      ...
      controller_package_uri: "s3://sample-bucket/idea/releases/idea-virtual-desktop-controller-26.09.0.tar.gz",
      app_package_uri: "s3://sample-bucket/idea/releases/idea-scheduler-26.09.0.tar.gz",
