...
import { BOOTSTRAP_SOURCE, ORACLE_CASES, caseContext } from "./oracle-context.ts";
...
requireFixtures(
  ...
  "python3 test/w16b/oracle_build.py --out tools/parity/fixtures/w16b-bootstrap-oracle",
);
