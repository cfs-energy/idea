...
export function change(
  ...
  resourceType: string,
  replacement?: string,
  details?: Array<{ Target?: { Attribute?: string; Name?: string; RequiresRecreation?: string }; ChangeSource?: string; CausingEntity?: string }>,
): {
  ResourceChange: {
    Action: string;
...
export function moduleRow(
  ...
  return { module_id: moduleId, name, type, status, stack_name: `sample-cluster-${moduleId}`, version: ideaVersion() };
}
