...
const KNOWN_RECONSTRUCTION_BLOCKER =
  /^could not run: (?:reconstructed fixture is missing required setting cluster\.(?:network\.vpc_id|iam\.roles|cluster_endpoints_lambda_arn)|fixture is missing synth-time read iam:ListRoles:\{"PathPrefix":"\/aws-service-role\/(?:es|opensearchservice)\.[^"]+"\})$/;
