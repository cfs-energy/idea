...
AMI_VALUE="ami-00cda30cf72311684" ## AMI ID for Amazon Linux 2 in us-east-2. AMI ID's can be found in source/idea/ideactl/resources/config/region_ami_config.yml
