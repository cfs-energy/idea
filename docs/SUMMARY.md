...
* [Access your IDEA cluster](first-time-users/access-your-idea-cluster/README.md)
  ...
  * [API tokens](first-time-users/api-tokens.md)
* [File Browser](first-time-users/file-browser.md)
* [Job status and costs](first-time-users/jobs.md)
...
* [Cluster operations](first-time-users/cluster-operations/README.md)
  * [Settings](first-time-users/cluster-operations/settings.md)
  * [Account synchronization](first-time-users/cluster-operations/account-reconciliation.md)
  * [Metrics history](first-time-users/cluster-operations/metrics-history.md)
  * [Update IDEA cluster](first-time-users/cluster-operations/update-idea-cluster/README.md)
    * [Update a module's code (idea-admin.sh deploy)](first-time-users/cluster-operations/update-idea-cluster/patch-idea-module.md)
    * [Move the control plane to containers](first-time-users/cluster-operations/update-idea-cluster/move-to-containers.md)
...
* [Cluster Manager](modules/cluster-manager/README.md)
  ...
  * [Reporting](modules/cluster-manager/reporting.md)
  * [Costs by user](modules/cluster-manager/costs-by-user.md)
